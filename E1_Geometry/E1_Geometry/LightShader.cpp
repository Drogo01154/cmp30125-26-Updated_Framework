...
LightTextureShader::LightTextureShader(ID3D11Device* device, TextureManager* textureManager, HWND hwnd) : BaseShader(device, hwnd), textureManager(textureManager)
{
	renderer
...
void LightTextureShader::setLightBuffer() {
