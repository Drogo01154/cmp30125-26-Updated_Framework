...
OrthoMesh::OrthoMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, const OrthoMeshData& orthoData) {
	width = orthoData.width;
	height = orthoData.height;
	xPosition = orthoData.xPosition;
	yPosition = orthoData.yPosition;
}
